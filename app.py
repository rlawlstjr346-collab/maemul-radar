...
import streamlit.components.v1 as components  # [1번 기능용 임포트 추가]
import urllib.parse
import requests
import re
import random
...
with col_right:
    ...
    with tab_m1:
        quick_opt = st.radio("빠른 선택", ["👋 구매 문의", "💸 가격 제안", "📦 택배비 포함"], label_visibility="collapsed")
        st.code("안녕하세요! 구매 가능할까요?", language="text") # 간략화
